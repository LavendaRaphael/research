...
character (len=100)                 :: temp_char0, temp_char (10), leng=" (65 ('='), ", infile, datafile, outfile="protonhbond_gro", errfile='my',logfile="protonhbond_gro"
...
errfile = trim(errfile)//trim(adjustl(temp_char0))//'.err'
logfile = trim(logfile)//trim(adjustl(temp_char0))//'.log'
outfile = trim(outfile)//trim(adjustl(temp_char0))//'.out'
