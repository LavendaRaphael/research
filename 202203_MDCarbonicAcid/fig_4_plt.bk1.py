...
def fig_b(ax):
    ...
    plot.inset_fig(
        ax,
        dict_img = {
            dir_cc+'1.308542.png': (0.2-dx/2, 0.8-dy/2, dx, dy),
            dir_cc+'1.308546.png': (0.4-dx/2, 0.8-dy/2, dx, dy),
            dir_cc+'1.308558.png': (0.6-dx/2, 0.8-dy/2, dx, dy),
            dir_cc+'1.308578.png': (0.8-dx/2, 0.8-dy/2, dx, dy),
        }
    )
...
def main():
    ...
    fig = plt.figure( figsize = (8.6*cm, (6+5)*cm) )

    gs = fig.add_gridspec(2, 1, height_ratio=[6,5], left=0.01, right=0.99, bottom=0.01, top=0.99)
