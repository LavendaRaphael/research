...
if (pic[1]):
    ...
    float_onset = 531
    array2d_xdata, array2d_ydata, _ = from_xas_modules.def_xas_findtm( array2d_xdata=array2d_xdata, array2d_ydata=array2d_ydata, array2d_kb=array2d_kb, float_onset=float_onset)
