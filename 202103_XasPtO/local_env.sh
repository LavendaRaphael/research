...
local_env=false
echo "#=========================================================================[local_env.sh]"
# work_dir=${goto_pto_work_110}Pt.110.x12y2z4.5_O22_vac15/
# work_dir=${goto_pto_work_110}Pt.110.x12y2z4.5_O22_vac15/vasp_sch.aimd2_932/
# work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O6_vac15/
# work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O1_vac15/
# work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O2x_vac15/
# work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O2y_vac15/
 work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O2.14_vac15/
# work_dir=${goto_pto_work_110}Pt.110.x2y3z4.5_O3xy_vac15/
