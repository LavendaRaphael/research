...
!===============================================================[xas_norm.in]
!datafile       "wernet2004_water.dat"
!e_align        535.0d0                         #eV
!area           10.d0
!e_begin        532.d0                          #eV
!e_end          546.d0                          #eV
!===============================================================[DATAFILE]
!wernet2004_water.dat
!===============================================================[OUTFILE]
!wernet2004_water.dat.norm
!wernet2004_water.dat.log
![my.err]
!==========================================================================================
program main
implicit none
...
real (DP)                        :: e_align, area, e_begin, e_end, xas_sum, e_onset
...
input_list = (/'datafile','e_align','area','e_begin','e_end'/)
do i = 1, input_tot
do while (.true.)
